package com.kv.iprojectlib.ui.viewpager;
 ...
 * Kevin Feng   1.0        2014年11月24日       Created
 *
 * </pre>
 * @since 1.
 */
public class BTViewPager extends ViewPager {
    ...
    private static final int MOVE_LIMITATION = 3;// 触发移动的像素距离
    ...
    public void computeScroll() {
        ...
        if (mScroller.computeScrollOffset()) {
            Log.d(TAG, "[BTViewPager->]computeScroll x = " + mScroller.getCurrX());
    ...
    public void snapToDestination() {
        ...
        Log.d(TAG, "[BTViewPager->]snapToDestination screenWidth = " + screenWidth + " destScreen = " + destScreen);
    ...
    public void snapToScreen(int whichScreen) {
        ...
        if (getScrollX() != (whichScreen * getWidth())) {
            ...
            Log.d(TAG, "[BTViewPager->]snapToScreen-whichScreen = " + whichScreen + " delta = " + delta + " scrollX = "
                    + getScrollX());
