...
public class AmountUtils {
    ...
    public static String getYuan(double fen) {
        double yuan = fen / 100.00;
        DecimalFormat dft = new DecimalFormat("0.00");
        return dft.format(yuan);
    }
    ...
    public static String getDiscountFormat(double num) {
        DecimalFormat dft = new DecimalFormat("0.00");
        return dft.format(num);
    }
    
    public static String getAmountFormat(double num) {
        DecimalFormat dft = new DecimalFormat("0.00");
        return dft.format(num);
    }
}
