package com.kv.iprojectlib.plugin.qrcodescan.mining.app.zxing.encoding;
...
public final class EncodingHandler {
    ...
    protected static Bitmap mixtureBitmap(Bitmap first, Bitmap second, PointF fromPoint) {
        ...
        int marginW = 20;
        Bitmap newBitmap = Bitmap.createBitmap(first.getWidth() + second.getWidth() + marginW, first.getHeight()
                + second.getHeight(), Config.ARGB_4444);
