...
public class XHeaderView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.ip_pr_vw_header, null);
    ...
    public void setState(int state) {
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                mHintTextView.setText(R.string.ip_pr_header_hint_refresh_normal);
                break;
            ...
            case STATE_READY:
                if (mState != STATE_READY) {
                    ...
                    mHintTextView.setText(R.string.ip_pr_header_hint_refresh_ready);
                }
                break;

            case STATE_REFRESHING:
                mHintTextView.setText(R.string.ip_pr_header_hint_refresh_loading);
                break;
