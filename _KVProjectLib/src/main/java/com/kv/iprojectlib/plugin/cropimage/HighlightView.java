...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(R.drawable.ip_ci_camera_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(R.drawable.ip_ci_camera_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(R.drawable.ip_ci_indicator_autocrop);
    }
