...
//    private ImageView mHintImage;
    ...
    private void initView(Context context) {
        mLayout = LayoutInflater.from(context).inflate(R.layout.ip_pr_vw_footer, null);
...
//                    mHintImage.clearAnimation();
//                }
                mHintView.setText(R.string.ip_pr_footer_hint_load_normal);
                break;
...
//                    mHintImage.startAnimation(mRotateUpAnim);
                    mHintView.setText(R.string.ip_pr_footer_hint_load_ready);
                }
                break;
