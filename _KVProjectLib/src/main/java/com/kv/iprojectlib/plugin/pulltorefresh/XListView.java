    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            default:
                ...
                } else if (getLastVisiblePosition() == mTotalItemCount - 1 && ev.getAction() == MotionEvent.ACTION_UP) {
                    // invoke load more.
...
//                    }
    ...
    public void setFootLoadError() {
        mFooterView.getmHintView().setText(R.string.ip_pr_footer_hint_load_again);
    }
}
